...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (!prefersReducedMotion && ticketScene && ticketCard) {
    ...
    window.addEventListener('mousemove', (e) => {
      ...
      const bottomRightRibbon = document.querySelector('.film-tape-bottom-right-wrapper');
      if (bottomRightRibbon) {
        bottomRightRibbon.style.transform = `translate3d(${-normX * 0.3}px, ${normY * 0.25}px, 0)`;
      }
    });
